...
module.exports = {
  ...
  usage: `${commandPrefix}ai2 <pertanyaan>`,
  async execute(sock, msg, args) {
    if (!args.length) return sock.sendMessage(msg.key.remoteJid, { text: `Contoh: ${commandPrefix}ai2 apa itu cinta?` }, { quoted: msg });
