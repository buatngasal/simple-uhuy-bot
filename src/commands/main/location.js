  ...
  async execute(sock, msg, args) {
    ...
    try {
      ...
      const sentLocation = await sock.sendMessage(msg.key.remoteJid, {
        location: { 
          degreesLatitude: data.lat || 0, 
          degreesLongitude: data.lon || 0,
          name: `IP: ${data.query}`,
      ...
      let caption = `*🌐 IP ADDRESS INFORMATION*\n\n`;
...
// [fix] track IP details (regular, proxy, or specific IP)
